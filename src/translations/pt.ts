export const translations = {
  ...
  inventory: {
    ...
    transactions: 'Transações de Estoque',
    addItem: 'Adicionar Item ao Estoque',
    editItem: 'Editar Item',
    deleteItem: 'Excluir Item',
    useStock: 'Utilizar Estoque',
    noItems: 'Nenhum item em estoque',
    ...
    eventSelection: 'Selecionar Evento',
  ...
  requests: {
    title: 'Solicitações',
    addButton: 'Adicionar Solicitação',
    ...
    createSuccess: 'Solicitação criada com sucesso',
    updateSuccess: 'Solicitação atualizada com sucesso',
    deleteSuccess: 'Solicitação excluída com sucesso',
    approveSuccess: 'Solicitação aprovada com sucesso',
    rejectSuccess: 'Solicitação rejeitada com sucesso',
    createError: 'Erro ao criar solicitação',
    updateError: 'Erro ao atualizar solicitação',
    deleteError: 'Erro ao excluir solicitação',
    approveError: 'Erro ao aprovar solicitação',
